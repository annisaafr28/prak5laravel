...
<body>
    ...
    <div class="container-sm mt-5">
        <form action="<?php echo e(route('employees.update', ['employee' => $employee->employee_id])); ?>" method="POST" class="needs-validation" novalidate>
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" name="lastName" id="lastName" value="<?php echo e($employee -> lastname); ?>" placeholder="Enter Last Name" required="">
...
unset($__errorArgs, $__bag); ?>" type="text" name="email" id="email" value="<?php echo e($employee -> email); ?>" placeholder="Enter Email" required="">
...
unset($__errorArgs, $__bag); ?>" type="text" name="age" id="age" value="<?php echo e($employee -> age); ?>" placeholder="Enter Age" required="">
                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH D:\Kuliah\SEMESTER 4\PEMROGRAMAN FRAMEWORK\TUGAS\PRAKTIKUM 5\prak4cont\resources\views/employee/edit.blade.php ENDPATH**/ ?>